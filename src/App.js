...
class App extends Component {
 ...
 componentDidMount() {
    //Set the state of filteredLocations equal to the locations array data when the component did mount
  ...
  updateQuery = (query) => {
    ...
    console.log(query);
          ...
          if(query){
            //With the help of the following resource: https://stackoverflow.com/questions/41436253/how-to-filter-list-while-typing-with-input-field
...
//With the help of the following resource: https://stackoverflow.com/questions/29537299/react-how-do-i-update-state-item1-on-setstate-with-jsfiddle
  showModal = (place) => {
